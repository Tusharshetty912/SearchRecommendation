...
private var hint = ""
fun SearchRecommend(cont: Context,eT: EditText,recList: Array<String>,initialEditTextHint: String,delayForRecommendationInSecs: Long){
    editText = eT
    context = cont
    recommendList = recList
    hint = initialEditTextHint
